package com.zsl.tinycat.engine;

import com.zsl.tinycat.connector.HttpExchangeRequest;
    ...
    private Map<String, String> parseQuery(String query) {
        ...
        for (String s : ss) {
            ...
            if (n >= 1) {
                ...
                // 按照ServletRequest中对getParameter(name)定义，同一个name有多个value时，该方法只返回第一个value
